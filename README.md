...
1. What is React JS and what problems does it solve? Support your answer with concepts introduced in class and from your personal research on the web. Open source javascript library used for building user interfaces. allows us to create reusable ui components
1. Describe component state. used to store information about the component that can change overtime. change comes as a result of user events or system events.
1. Describe props. React Props are like function arguments in JavaScript and attributes in HTML.
